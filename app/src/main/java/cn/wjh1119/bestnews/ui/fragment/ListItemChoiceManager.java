...
/**
 * The ListItemChoiceManager class keeps track of which positions have been selected.  Note that it
 * doesn't take advantage of new adapter features to track changes in the underlying data.
 */
public class ListItemChoiceManager {
    ...
    private ListItemChoiceManager() {
    }

    ;

    public ListItemChoiceManager(RecyclerView.Adapter adapter) {
        mAdapter = adapter;
    }
